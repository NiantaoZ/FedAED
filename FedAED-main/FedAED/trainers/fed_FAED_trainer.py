...
class AsyncBidirectionalEvolution:
    ...
    def __init__(self, buffer_size=8, decay_factor=0.1):
...
class ClientFAED(ClientFedAvg):
    ...
    def __init__(
        ...
        super().__init__(args, device, criterion, dataloader, model, label_dict, num_class)
    ...
    def update_weights(self):
        ...
        # optimizer
        if self.args.fed_alg in ['fed_avg', 'fed_opt','FAED']:
        ...
        for iter in range(int(self.args.local_epochs)):
            for batch_idx, batch_data in enumerate(self.dataloader):
                ...
                # 总损失整合并反向传播
                total_loss = cls_loss + 3 * contrastive_loss  # Weight could be tuned
