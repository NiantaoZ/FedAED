...
Here we provide an example to quickly start with the experiments, and reproduce the PTB-XL results. We set the fixed seed for data partitioning, training client sampling.
