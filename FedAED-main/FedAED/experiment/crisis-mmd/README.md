...
Here we provide an example to quickly start with the experiments, and reproduce the CRISIS-MMD results from the paper. We set the fixed seed for data partitioning, training client sampling.
